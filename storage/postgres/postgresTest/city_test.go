...
// 			Guid:        uuid.NewString(),
// 			Title:       "Notebook",
// 			CountryId:   "d8a2a844-509c-4959-a93c-51af385fbbff",
// 			CityCode:    "AAC",
// 			Latitude:    "12.00",
// 			Longitude:   "32.000",
// 			Offset:      "1.00",
// 			TimezoneId:  "c46eab35-fcd8-4298-ab0d-f1aeb958bf89",
// 			CountryName: "Salaman",
// 		},
// 	}}
...
// 			_, err := citytestRepo.Create(*test.Input)
...
func TestCreateCity(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.Name, func(t *testing.T) {
			data, err := citytestRepo.Create(*test.Input)
			if test.WantErr || err != nil {
				t.Errorf("%s: got: %+v", test.Name, test.Input)
				return
			}
...
func TestGetByIdCity(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.Name, func(t *testing.T) {
			data, err := citytestRepo.GetById(*test.Input)
...
func TestUpdateCity(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.Name, func(t *testing.T) {
			data, err := citytestRepo.Update(*test.Input)
...
// 		t.Run(test.Name, func(t *testing.T) {
// 			data, err := citytestRepo.Delete(*test.Input)
