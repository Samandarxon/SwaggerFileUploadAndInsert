...
func TestCreateCountry(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.Name, func(t *testing.T) {
			data, err := countryTestRepo.Create(*test.Input)
...
func TestGetByIdCountry(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.Name, func(t *testing.T) {
			data, err := countryTestRepo.GetById(*test.Input)
...
func TestUpdateCountry(t *testing.T) {
	...
	for _, test := range tests {
		...
		t.Run(test.Name, func(t *testing.T) {
			data, err := countryTestRepo.Update(*test.Input)
...
// 		t.Run(test.Name, func(t *testing.T) {
// 			data, err := countryTestRepo.Delete(*test.Input)
